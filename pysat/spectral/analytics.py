...
def band_asymmetry(spectrum, low_endmember=None, high_endmember=None):
    ...
    ny = y.loc[low_endmember:high_endmember]

    (center, centervalue), _ = band_center(ny, low_endmember, high_endmember)

    print(center, centervalue)
    print(ny)
    print(ny.loc[:center])
    print(ny.loc[center:])
    area_left = band_area(ny.loc[:center], low_endmember, high_endmember)
    area_right = band_area(ny.loc[center:], low_endmember, high_endmember)
